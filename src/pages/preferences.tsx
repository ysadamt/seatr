...
const Preferences: NextPage = () => {
  ...
  const confirmChoice = (e: any) => {
    ...
    window.location.href = `/result?flags=${+(veteran as HTMLInputElement).checked},${+(disabled as HTMLInputElement).checked},${+(elderly as HTMLInputElement).checked}&seat=${+(aisle as HTMLInputElement).checked},${+(middle as HTMLInputElement).checked},${+(window2 as HTMLInputElement).checked}`window.location.href = `/result?flags=${+(veteran as HTMLInputElement).checked},${+(disabled as HTMLInputElement).checked},${+(elderly as HTMLInputElement).checked}&seat=${+(aisle as HTMLInputElement).checked},${+(middle as HTMLInputElement).checked},${+(window2 as HTMLInputElement).checked}`
  };
